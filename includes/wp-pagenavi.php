...
function pagenavi_stylesheets_custom() {
    if(@file_exists(get_stylesheet_directory_uri().'/pagenavi-css.css')) {
        wp_enqueue_style('wp-pagenavi_custom', get_stylesheet_directory_uri().'/pagenavi-css.css', false, '2.50', 'all');
    } else {
        wp_enqueue_style('wp-pagenavi_custom', plugins_url('wp-pagenavi/pagenavi-css.css'), false, '2.50', 'all');
    }
}
...
function wp_pagenavi_custom($before = '', $after = '') {
    ...
    if (!is_single()) {
        ...
        $pagenavi_options_custom = get_option('pagenavi_options_custom');
...
function pagenavi_init_custom() {
    ...
    $pagenavi_options_custom['pages_text'] = __('Page %CURRENT_PAGE% of %TOTAL_PAGES%','visionary');
    $pagenavi_options_custom['current_text'] = '%PAGE_NUMBER%';
    $pagenavi_options_custom['page_text'] = '%PAGE_NUMBER%';
    $pagenavi_options_custom['first_text'] = '&laquo; '. __('First','visionary');
    $pagenavi_options_custom['last_text'] = __('Last','visionary').' &raquo;';
    $pagenavi_options_custom['next_text'] = '&raquo;';
    $pagenavi_options_custom['prev_text'] = '&laquo;';
    $pagenavi_options_custom['dotright_text'] = '...';
    $pagenavi_options_custom['dotleft_text'] = '...';
    ...
    add_option('pagenavi_options_custom', $pagenavi_options_custom);
}